        ...
        final updatedScripts = scene.scripts.map((script) {
          ...
          if (!script.isNarrator) {
            ...
            for (final characterEntry in characterNameMap.entries) {
              ...
              final scriptFirstLine = script.scriptText.split('\n').first;
              if (scriptFirstLine.toLowerCase().contains(characterName)) {
