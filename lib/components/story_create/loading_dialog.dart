...
class LoadingDialog extends StatefulWidget {
  ...
  const LoadingDialog({super.key, this.onCancel, this.progress = 0.0});
  ...
  static void show(
    ...
    showDialog(
      ...
      builder:
          (BuildContext context) =>
              LoadingDialog(onCancel: onCancel, progress: progress),
    );
  }
  ...
  static void updateProgress(BuildContext context, double progress) {
    ...
    final LoadingDialogState? state =
        context.findAncestorStateOfType<LoadingDialogState>();
    if (state != null) {
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: CircularProgressIndicator(
                        value:
                            _progress, // Use actual progress value from parent
                    ...
                    Icon(Icons.auto_stories, size: 32, color: AppColors.primary)
                ...
                Text(
                  _getEstimatedTime(),
                  style: TextStyle(
                    color: AppColors.textMedium.withValues(alpha: .8),
                    fontSize: 12,
